// Initial Setup
export function makeBubbles (canvas) {
  ...
  const colors = ['#fbb217', '#e65c23', '#87c23f', '#6ac7b4', '#45c2e6'];
  ...
  function resolvedCollision(particle, otherParticle) {
      ...
      this.update = particles => {
          ...
          for (var i = 0; i < particles.length; i++) {
            ...
            if (distance(this.x, this.y, particles[i].x, particles[i].y) - this.radius * 2 < 0) {
              resolvedCollision(this, particles[i]);
            }
          }
          ...
          if (distance(mouse.x, mouse.y, this.x, this.y) < 160 && this.opacity < 0.3) {
            this.opacity += 0.02;
